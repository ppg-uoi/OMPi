...
{
	int pe_exit            [PARALLELLA_CORES]; // To ensure that PE's have finished a kernel
	int master_thread      [PARALLELLA_CORES]; // ID of current team's master PEpe_request
	int master_level       [PARALLELLA_CORES]; // level of current team's master PEpe_request
	int team_threads       [MAX_ACTIVE_LEVELS][PARALLELLA_CORES]; // PEs of current OpenMP team
	int openmp_id          [PARALLELLA_CORES]; // PEs of current OpenMP team
	...
	int team_members       [MAX_ACTIVE_LEVELS][PARALLELLA_CORES][PARALLELLA_CORES]; // Which cores are in my team?
#ifdef MEASURE
